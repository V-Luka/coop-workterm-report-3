...
function App() {
  ...
  return (
      ...
      <div className="reportContent">
        ...
        <p className="internalText">My first goal was to improve my current organization and time management. I was able to achieve this goal through our scheduled sprints, time estimation on tickets and daily stand-up meetings to discuss progress of tickets, blockers, and anything else related to the ticket. I continuously used collaboration tools to manage my work and assure all work is completed on my end. I also used version control tools to manage repos and to properly merge updated files to the proper repo after the information is validated.\tMy second goal for this work term was to improve my written communication. This goal was achieved through regular messages with my co-workers, back and forth emails between numerous parties and written updates to provide more context for my co-workers to better understand the problem that is at hand.\tMy final goal was to improve my ability to work in a team. My ability to work in a team improved tremendously from different reasons. The first reason was the multiple different group chats between different teams to keep everyone updated on the tasks that are being worked on and to show how work from a different team can be used by another team. Along with this, daily stand-up meetings with the entire Dev Ops team along with members from different teams allows for continuous communication regarding the progress of tickets that each team is working on. The friendliness of all co-workers that I worked with also made the environment welcoming and I was able to openly ask questions even if they were obvious to the experienced workers, they were more than welcome to help me understand it to the same degree as they do. I used many different tools available at Sun Life during my work term to achieve this goal.</p>
